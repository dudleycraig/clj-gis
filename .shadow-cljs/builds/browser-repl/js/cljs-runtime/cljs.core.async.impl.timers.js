...
var i_56668 = (0);
while(true){
if((i_56668 < arr.length)){
(arr[i_56668] = null);

var G__56669 = (i_56668 + (1));
i_56668 = G__56669;
continue;
} else {
}
...
var i_56676 = (self__.level + (1));
while(true){
if((i_56676 <= (new_level + (1)))){
(update[i_56676] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_56678 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_56678[i]));
} else {
x__$2.forward.push((((i < links_56678.length))?(links_56678[i]):null));
}

if((i < links_56678.length)){
(links_56678[i] = x__$2);
} else {
links_56678.push(x__$2);
}
...
var i_56681 = (0);
while(true){
if((i_56681 <= self__.level)){
var links_56682 = (update[i_56681]).forward;
if((x__$1 === (((i_56681 < links_56682.length))?(links_56682[i_56681]):null))){
(links_56682[i_56681] = (x__$1.forward[i_56681]));

var G__56683 = (i_56681 + (1));
i_56681 = G__56683;
continue;
} else {
var G__56684 = (i_56681 + (1));
i_56681 = G__56684;
continue;
}
} else {
...
var G__56686 = nx;
var G__56687 = (level__$1 - (1));
x = G__56686;
level__$1 = G__56687;
continue;
} else {
var G__56688 = x;
var G__56689 = (level__$1 - (1));
x = G__56688;
level__$1 = G__56689;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__56691 = nx;
var G__56692 = (level__$1 - (1));
x = G__56691;
level__$1 = G__56692;
continue;
} else {
var G__56693 = x;
var G__56694 = (level__$1 - (1));
x = G__56693;
level__$1 = G__56694;
continue;
}
