...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_56320 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_56320(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_56321 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_56321(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56322 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56322(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56323 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56323(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56324 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56324(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56325 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56325(reader);
}
});
...
var G__56375 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__56376 = s.append(c);
c = G__56375;
s = G__56376;
continue;
}
