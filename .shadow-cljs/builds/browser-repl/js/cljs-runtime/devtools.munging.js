...
var o53243 = temp__5751__auto__;
var temp__5751__auto____$1 = (o53243["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o53244 = temp__5751__auto____$1;
return (o53244["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__41957__auto___53481 = t;
(o__41957__auto___53481["cljs$lang$ctorPrWriter"]).call(o__41957__auto___53481,t,writer);
}catch (e53249){var __53482 = e53249;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__53262 = num_code;
switch (G__53262) {
case (1):
return (185);
...
}catch (e53275){var _e__41964__auto__ = e53275;
return false;
}})())){
...
var vec__53281 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53281,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var o53297 = temp__5751__auto__;
var temp__5751__auto____$1 = (o53297["dependencies_"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o53298 = temp__5751__auto____$1;
return (o53298["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4818__auto___53493 = arguments.length;
var i__4819__auto___53494 = (0);
while(true){
if((i__4819__auto___53494 < len__4818__auto___53493)){
args__4824__auto__.push((arguments[i__4819__auto___53494]));

var G__53495 = (i__4819__auto___53494 + (1));
i__4819__auto___53494 = G__53495;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__53308){
var vec__53309 = p__53308;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53309,(0),null);
...
var G__53498 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__53499 = cljs.core.butlast(remaining_tokens);
name_tokens = G__53498;
remaining_tokens = G__53499;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq53304){
var G__53305 = cljs.core.first(seq53304);
var seq53304__$1 = cljs.core.next(seq53304);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53305,seq53304__$1);
}));
...
var vec__53320 = cljs.core.split_with((function (p1__53317_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__53317_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53320,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53320,(1),null);
...
var vec__53331 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53331,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53331,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__53501 = cljs.core.rest(remaining_tokens);
var G__53502 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__53501;
name_tokens = G__53502;
continue;
} else {
...
var vec__53341 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53341,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53341,(1),null);
var vec__53344 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53344,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53344,(1),null);
var vec__53347 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53347,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53347,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53347,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53347,(3),null);
...
var vec__53361 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53361,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53361,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53361,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53361,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53361,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53361,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__53366 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53366,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53366,(1),null);
var vec__53370 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53370,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53370,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__53379 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__53379) : devtools.munging.parse_fn_info_deep.call(null,G__53379));
})()));
}
} else {
return fn_info;
...
var G__53519 = (arity + (1));
var G__53520 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__53391){
var vec__53392 = p__53391;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53392,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53392,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53403_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__53403_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53406_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__53406_SHARP_);
}),sorted_infos);
...
var args__4824__auto__ = [];
var len__4818__auto___53534 = arguments.length;
var i__4819__auto___53535 = (0);
while(true){
if((i__4819__auto___53535 < len__4818__auto___53534)){
args__4824__auto__.push((arguments[i__4819__auto___53535]));

var G__53536 = (i__4819__auto___53535 + (1));
i__4819__auto___53535 = G__53536;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__53415){
var vec__53419 = p__53415;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53419,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq53410){
var G__53411 = cljs.core.first(seq53410);
var seq53410__$1 = cljs.core.next(seq53410);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53411,seq53410__$1);
}));
...
var map__53433 = options;
var map__53433__$1 = cljs.core.__destructure_map(map__53433);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53433__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53433__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53433__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53433__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__53434 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53434,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53434,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53434,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53434,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53434,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53434,(5),null);
...
}catch (e53439){var _e__41964__auto__ = e53439;
...
var G__53554 = (obj[cljs.core.first(path)]);
var G__53555 = cljs.core.rest(path);
obj = G__53554;
path = G__53555;
continue;
} else {
...
var _STAR_ = (function (accum,p__53457){
var vec__53458 = p__53457;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53458,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53458,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__53463){
var vec__53464 = p__53463;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53464,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53464,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53464,(2),null);
...
var post_process = (function (p__53471){
var vec__53472 = p__53471;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53472,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53472,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53470_SHARP_){
return (obj[cljs.core.first(p1__53470_SHARP_)]);
}),sorted_matches);
