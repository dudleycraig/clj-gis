...
var G__53551 = devtools.prefs.pref(v);
v = G__53551;
continue;
} else {
return v;
...
}catch (e53489){var _e__41964__auto__ = e53489;
return false;
}})();
...
}catch (e53491){var _e__41964__auto__ = e53491;
return false;
}})();
...
}catch (e53496){var _e__41964__auto__ = e53496;
return false;
}}
}
});
...
var vec__53513 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53513,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53513,(1),null);
...
return cljs.core.some((function (p1__53521_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__53521_SHARP_);
}),template);
});
