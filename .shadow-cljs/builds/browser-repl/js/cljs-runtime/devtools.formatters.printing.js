...
var len__4818__auto___53638 = arguments.length;
var i__4819__auto___53639 = (0);
while(true){
if((i__4819__auto___53639 < len__4818__auto___53638)){
args__4824__auto__.push((arguments[i__4819__auto___53639]));

var G__53640 = (i__4819__auto___53639 + (1));
i__4819__auto___53639 = G__53640;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq53560){
var G__53562 = cljs.core.first(seq53560);
var seq53560__$1 = cljs.core.next(seq53560);
var G__53563 = cljs.core.first(seq53560__$1);
var seq53560__$2 = cljs.core.next(seq53560__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53562,G__53563,seq53560__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__53592_SHARP_){
return (!((cljs.core.meta(p1__53592_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53609__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e53610){var _e__41964__auto__ = e53610;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e53612){var _e__41964__auto__ = e53612;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__53622 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__53623 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__53623);

try{var map__53628 = opts;
var map__53628__$1 = cljs.core.__destructure_map(map__53628);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53628__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__53622);
}});
...
var temp__5751__auto___53649 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___53649)){
var managed_print_level_53650 = temp__5751__auto___53649;
var _STAR_print_level_STAR__orig_val__53634_53651 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__53635_53652 = managed_print_level_53650;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__53635_53652);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__53632_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__53632_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__53634_53651);
}} else {
job_fn();
}
